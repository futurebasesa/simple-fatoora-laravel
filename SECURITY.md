...
Security fixes are provided for the latest `0.1.x` release line. After a newer minor or major line is released, upgrade to its latest patch before reporting a defect.
...
Please allow the maintainers time to investigate and coordinate a fix before public disclosure. Package support questions and ordinary defects belong in [GitHub issues](https://github.com/futurebasesa/simple-fatoora-laravel/issues).
